...
system.yaml]<br>
Charles (use proxifier)/ Fiddler (hexedit leagueClieht replace --no-proxy  with  00 hex  now can log client data with fiddler) Wooxy<br>
JPEXS FLash Decompiler <br>
**===========================**<br><br>
